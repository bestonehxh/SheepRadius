...
[![Download SheepRadius for macOS](https://img.shields.io/badge/Download-SheepRadius_0.1_%2833%29_for_macOS-2ea44f?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/bestonehxh/SheepRadius/releases/latest)

**[Get the latest release →](https://github.com/bestonehxh/SheepRadius/releases/latest)** — download
`SheepRadius-0.1-33.zip`, unzip, and drag **SheepRadius.app** into `Applications`. The build is
